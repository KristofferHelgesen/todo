...
exports.BtnClearFormatting = createButton('Clear formatting', 'T̲ₓ', 'removeFormat');
exports.BtnItalic = createButton('Italic', '𝑰', 'italic');
exports.BtnLink = createButton('Link', '🔗', function (selected) {
